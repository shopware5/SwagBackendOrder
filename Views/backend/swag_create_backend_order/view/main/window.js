...
//
Ext.define('Shopware.apps.SwagCreateBackendOrder.view.main.Window', {
    ...
    snippets: {
        title: '{s namespace="backend/swag_create_backend_order/view/main" name="swagcreatebackendorder/title"}Create Order{/s}',
        buttons: {
            cancel: '{s namespace="backend/swag_create_backend_order/view/main" name="swagcreatebackendorder/buttons/cancel"}Cancel{/s}',
            create: '{s namespace="backend/swag_create_backend_order/view/main" name="swagcreatebackendorder/buttons/create"}Create{/s}',
            createAndNew: '{s namespace="backend/swag_create_backend_order/view/main" name="swagcreatebackendorder/buttons/create_and_new"}Create and new{/s}'
        },
        message: {
            closeConfirmTitle: '{s namespace="backend/swag_create_backend_order/view/main" name="swagcreatebackendorder/msg/confirm_title"}Warning{/s}',
            closeConfirmText: '{s namespace="backend/swag_create_backend_order/view/main" name="swagcreatebackendorder/msg/confirm_close"}Are you sure to close this window?{/s}'
        }
    ...
    createCustomerInformation: function() {
        ...
        return Ext.create('SwagCreateBackendOrder.main.CustomerInformation', {
    ...
    createToolbar: function() {
        ...
        return Ext.create('SwagCreateBackendOrder.view.main.Toolbar', {
            subApplication: me.subApplication
        });
    },
    ...
    createShippingInformationPanel: function() {
        ...
        return Ext.create('SwagCreateBackendOrder.view.main.ShippingCosts', {
    ...
    createAdditionalInformationPanel: function () {
        ...
        return Ext.create('SwagCreateBackendOrder.view.main.AdditionalInformation', {
            subApplication: me.subApplication
        });
    },
     ...
     *
     * @returns [Shopware.apps.SwagCreateBackendOrder.view.main.list.Positions]
     */
    createPositionGrid: function() {
        var me = this;

        return me.positionsGrid = Ext.create('SwagCreateBackendOrder.view.main.list.Positions', {
            subApplication: me.subApplication,
            orderModel: me.orderModel
        });
    },
    ...
    createTotalCostsOverview: function() {
        ...
        return Ext.create('Shopware.apps.SwagCreateBackendOrder.view.main.TotalCostsOverview', {
            subApplication: me.subApplication,
            orderModel: me.orderModel,
