...
//
Ext.define('Shopware.apps.SwagCreateBackendOrder.view.main.TotalCostsOverview', {
    ...
    snippets: {
        ...
        shippingCosts: '{s namespace="backend/swag_create_backend_order/view/costs_overview" name="swag_create_backend_order/costs_overview/shipping_costs"}Shipping costs: {/s}',
        total: '{s namespace="backend/swag_create_backend_order/view/costs_overview" name="swag_create_backend_order/costs_overview/total"}Total: {/s}',
        totalWithoutTax: '{s namespace="backend/swag_create_backend_order/view/costs_overview" name="swag_create_backend_order/costs_overview/total_without_tax"}Total without tax: {/s}',
        taxSum: '{s namespace="backend/swag_create_backend_order/view/costs_overview" name="swag_create_backend_order/costs_overview/tax_sum"}Tax sum: {/s}',
        netOrder: '{s namespace="backend/swag_create_backend_order/view/costs_overview" name="swag_create_backend_order/costs_overview/net_order"}Net order{/s}'
    },
    ...
    createTotalCostsStore: function() {
        var me = this;
        me.totalCostsModel = Ext.create('Shopware.apps.SwagCreateBackendOrder.model.TotalCosts', {});
