...
//
Ext.define('Shopware.apps.SwagCreateBackendOrder.view.main.list.Grid', {
    ...
    snippets: {
        title : '{s namespace="backend/swag_create_backend_order/view/grid" name="swag_create_backend_order/position/grid/title"}Positions{/s}',
        columns: {
            number: '{s namespace="backend/swag_create_backend_order/view/grid" name="swag_create_backend_order/position/grid/number"}Articlenumber{/s}',
            name: '{s namespace="backend/swag_create_backend_order/view/grid" name="swag_create_backend_order/position/grid/name"}Name{/s}',
            quantity: '{s namespace="backend/swag_create_backend_order/view/grid" name="swag_create_backend_order/position/grid/quantity"}Quantity{/s}',
            price: '{s namespace="backend/swag_create_backend_order/view/grid" name="swag_create_backend_order/position/grid/price"}Price{/s}',
            total: '{s namespace="backend/swag_create_backend_order/view/grid" name="swag_create_backend_order/position/grid/total"}Total{/s}',
            tax: '{s namespace="backend/swag_create_backend_order/view/grid" name="swag_create_backend_order/position/grid/tax"}Tax in %{/s}',
            inStock: '{s namespace="backend/swag_create_backend_order/view/grid" name="swag_create_backend_order/position/grid/instock"}Instock{/s}'
        },
        toolbar: {
            delete : '{s namespace="backend/swag_create_backend_order/view/grid" name="swag_create_backend_order/position/grid/toolbar/delete"}Delete all selected{/s}',
            add : '{s namespace="backend/swag_create_backend_order/view/grid" name="swag_create_backend_order/position/grid/toolbar/add"}Add position{/s}'
        },
        error: {
            articleNumberTitle: '{s namespace="backend/swag_create_backend_order/view/grid" name="swag_create_backend_order/position/grid/error/article_number_title"}Invalid article{/s}',
    ...
    createArticleSearch: function(returnValue, hiddenReturnValue, name ) {
        ...
        return Ext.create('Shopware.apps.SwagCreateBackendOrder.view.main.list.ArticleSearchField', {
            name: name,
