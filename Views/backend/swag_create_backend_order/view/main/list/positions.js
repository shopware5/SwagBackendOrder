...
//
Ext.define('Shopware.apps.SwagCreateBackendOrder.view.main.list.Positions', {
     ...
     */
    alternateClassName: 'SwagCreateBackendOrder.view.main.list.Positions',
    ...
    createOrderPositionGrid: function() {
        ...
        return me.orderPositionGrid = Ext.create('Shopware.apps.SwagCreateBackendOrder.view.main.list.Grid', {
