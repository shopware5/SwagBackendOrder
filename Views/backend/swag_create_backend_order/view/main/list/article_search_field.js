...
//
Ext.define('Shopware.apps.SwagCreateBackendOrder.view.main.list.ArticleSearchField', {
    ...
    initComponent: function() {
        ...
        me.dropDownStore = Ext.create('Shopware.apps.SwagCreateBackendOrder.store.Article', {
            listeners: {
                single: true,
                load: function () {
