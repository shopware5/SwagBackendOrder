...
//
Ext.define('Shopware.apps.SwagCreateBackendOrder.view.main.CustomerInformation.Payment', {
     ...
     */
    alternateClassName: 'SwagCreateBackendOrder.view.main.CustomerInformation.Payment',
    ...
    snippets: {
        title: '{s namespace="backend/swag_create_backend_order/view/customer_information" name="swag_create_backend_order/customer_information/payment/title"}Shipping address{/s}',
        paymentData: {
            accountHolder: '{s namespace="backend/swag_create_backend_order/view/customer_information" name="swag_create_backend_order/customer_information/payment/account_holder"}Account holder:{/s}',
            bankCode: '{s namespace="backend/swag_create_backend_order/view/customer_information" name="swag_create_backend_order/customer_information/payment/bank_code"}Bank code:{/s}',
            accountNumber: '{s namespace="backend/swag_create_backend_order/view/customer_information" name="swag_create_backend_order/customer_information/payment/account_number"}Account number:{/s}',
            bic: '{s namespace="backend/swag_create_backend_order/view/customer_information" name="swag_create_backend_order/customer_information/payment/bic"}BIC:{/s}',
            iban: '{s namespace="backend/swag_create_backend_order/view/customer_information" name="swag_create_backend_order/customer_information/payment/iban"}IBAN:{/s}',
            bankName: '{s namespace="backend/swag_create_backend_order/view/customer_information" name="swag_create_backend_order/customer_information/payment/bank_name"}Bank name:{/s}',
            noPaymentData: '{s namespace="backend/swag_create_backend_order/view/customer_information" name="swag_create_backend_order/customer_information/payment/no_payment_data"}No payment data found.{/s}'
        }
    },
