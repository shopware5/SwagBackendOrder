...
//
Ext.define('Shopware.apps.SwagCreateBackendOrder.view.main.ShippingCosts', {

    extend: 'Ext.panel.Panel',

    alternateClassName: 'SwagCreateBackendOrder.view.main.ShippingCosts',
    ...
    snippets: {
        ...
        fields: {
            art: '{s namespace="backend/swag_create_backend_order/view/shipping_costs" name="swagcreatebackendorder/shipping_costs/fields/art"}Shipping art{/s}',
            costs: '{s namespace="backend/swag_create_backend_order/view/shipping_costs" name="swagcreatebackendorder/shipping_costs/fields/costs"}Shipping costs{/s}',
            costsNet: '{s namespace="backend/swag_create_backend_order/view/shipping_costs" name="swagcreatebackendorder/shipping_costs/fields/costs_net"}Shipping costs net{/s}'
        }
    },
