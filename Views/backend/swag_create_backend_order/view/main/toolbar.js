...
//
Ext.define('Shopware.apps.SwagCreateBackendOrder.view.main.Toolbar', {

    extend: 'Ext.toolbar.Toolbar',

    alternateClassName: 'SwagCreateBackendOrder.view.main.Toolbar',
    ...
    snippets: {
        buttons: {
            openCustomer: '{s namespace="backend/swag_create_backend_order/view/toolbar" name="swag_create_backend_order/toolbar/button/open_customer"}Open Customer{/s}',
            createCustomer: '{s namespace="backend/swag_create_backend_order/view/toolbar" name="swag_create_backend_order/toolbar/button/create_customer"}Create Customer{/s}',
            createGuest: '{s namespace="backend/swag_create_backend_order/view/toolbar" name="swag_create_backend_order/toolbar/button/create_guest"}Create Guest{/s}'
        },
        shop: {
            noCustomer: '{s namespace="backend/swag_create_backend_order/view/toolbar" name="swag_create_backend_order/toolbar/shop/label/no_costumer"}Shop: No customer selected.{/s}',
            default: '{s namespace="backend/swag_create_backend_order/view/toolbar" name="swag_create_backend_order/toolbar/shop/label/default"}Main shop: {/s}'
        },
        currencyLabel: '{s namespace="backend/swag_create_backend_order/view/toolbar" name="swag_create_backend_order/toolbar/currency/label"}Choose currency{/s}',
        languageLabel: '{s namespace="backend/swag_create_backend_order/view/toolbar" name="swag_create_backend_order/toolbar/language/label"}Language{/s}'
    },
    ...
    createCustomerSearch: function(returnValue, hiddenReturnValue, name ) {
        ...
        return Ext.create('Shopware.apps.SwagCreateBackendOrder.view.main.CustomerSearch', {
            name: name,
