...
//
Ext.define('Shopware.apps.SwagCreateBackendOrder.view.main.AdditionalInformation', {

    extend: 'Ext.panel.Panel',

    alternateClassName: 'SwagCreateBackendOrder.view.main.AdditionalInformation',
    ...
    snippets: {
        title: '{s namespace="backend/swag_create_backend_order/view/additional_information" name="swag_create_backend_order/additional/title"}Additional Information{/s}',
        additionalInformation: {
            attribute1Label: '{s namespace="backend/swag_create_backend_order/view/additional_information" name="swag_create_backend_order/additional/attribute1/label"}Attribute 1{/s}',
            attribute2Label: '{s namespace="backend/swag_create_backend_order/view/additional_information" name="swag_create_backend_order/additional/attribute2/label"}Attribute 2{/s}',
            attribute3Label: '{s namespace="backend/swag_create_backend_order/view/additional_information" name="swag_create_backend_order/additional/attribute3/label"}Attribute 3{/s}',
