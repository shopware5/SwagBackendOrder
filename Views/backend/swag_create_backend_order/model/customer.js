...
Ext.define('Shopware.apps.SwagCreateBackendOrder.model.Customer', {
     ...
     */
    alternateClassName: 'SwagCreateBackendOrder.model.Customer',

    /**
     * required models for this model
     */
    requires: [
        'Shopware.apps.SwagCreateBackendOrder.model.Billing',
        'Shopware.apps.SwagCreateBackendOrder.model.Shipping',
        'Shopware.apps.SwagCreateBackendOrder.model.Debit',
    ...
    hasMany: [
        {
            name: 'billing',
            model: 'Shopware.apps.SwagCreateBackendOrder.model.Billing',
        ...
        {
            name: 'debit',
            model: 'Shopware.apps.SwagCreateBackendOrder.model.Debit',
