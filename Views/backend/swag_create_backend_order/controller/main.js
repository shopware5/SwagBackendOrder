...
//
Ext.define('Shopware.apps.SwagCreateBackendOrder.controller.Main', {
    ...
    snippets: {
        error: {
            customer: '{s namespace="backend/swag_create_backend_order/view/main" name="swagcreatebackendorder/error/customer"}Please select a customer.{/s}',
            billing: '{s namespace="backend/swag_create_backend_order/view/main" name="swagcreatebackendorder/error/billing"}Please select a billing address.{/s}',
            payment: '{s namespace="backend/swag_create_backend_order/view/main" name="swagcreatebackendorder/error/payment"}Please select a payment method.{/s}',
            shippingArt: '{s namespace="backend/swag_create_backend_order/view/main" name="swagcreatebackendorder/error/shipping_art"}Please select a shipping art.{/s}',
            positions: '{s namespace="backend/swag_create_backend_order/view/main" name="swagcreatebackendorder/error/positions"}Please add positions.{/s}',
            textArticleNumber: '{s namespace="backend/swag_create_backend_order/view/main" name="swagcreatebackendorder/error/textArticleNumber"}Wrong article number: {/s}',
            title: '{s namespace="backend/swag_create_backend_order/view/main" name="swagcreatebackendorder/error/title"}Error!{/s}',
            instanceTitle: '{s namespace="backend/swag_create_backend_order/view/main" name="swagcreatebackendorder/error/instanceTitle"}Error!{/s}',
            instanceText: '{s namespace="backend/swag_create_backend_order/view/main" name="swagcreatebackendorder/error/instanceText"}You can not create more than one order at the same time.{/s}'
        },
        success: {
            text: '{s namespace="backend/swag_create_backend_order/view/main" name="swagcreatebackendorder/success/text"}Order was created successfully.{/s}',
            title: '{s namespace="backend/swag_create_backend_order/view/main" name="swagcreatebackendorder/success/title"}Success!{/s}'
        },
        title: '{s namespace="backend/swag_create_backend_order/view/main" name="swagcreatebackendorder/title/selected_user"}Create order for{/s}'
    },
    ...
    init: function() {
        ...
        var createOrderWindow = Ext.getCmp('swagCreateBackendOrderWindow');
         ...
         */
        me.orderModel = Ext.create('Shopware.apps.SwagCreateBackendOrder.model.CreateBackendOrder', {});
        me.orderAttributeModel = Ext.create('Shopware.apps.SwagCreateBackendOrder.model.OrderAttribute', {});
        ...
        me.window = me.getView('main.Window').create({
            id: 'swagCreateBackendOrderWindow',
    ...
    onChangeAttrField: function(field, newValue, oldValue) {
        ...
        switch(field.name) {
            case 'attr1TxtBox': me.orderAttributeModel.set('attribute1', field.getValue());
                break;
            case 'attr2TxtBox': me.orderAttributeModel.set('attribute2', field.getValue());
                break;
            case 'attr3TxtBox': me.orderAttributeModel.set('attribute3', field.getValue());
                break;
            case 'attr4TxtBox': me.orderAttributeModel.set('attribute4', field.getValue());
                break;
            case 'attr5TxtBox': me.orderAttributeModel.set('attribute5', field.getValue());
                break;
            case 'attr6TxtBox': me.orderAttributeModel.set('attribute6', field.getValue());
                break;
            default:
                break;
        }
