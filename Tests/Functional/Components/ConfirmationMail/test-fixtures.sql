...
INSERT INTO `s_order_details` (id, orderID, ordernumber, articleID, articleordernumber, price, quantity, `name`, status, shipped, shippedgroup, releasedate, modus, esdarticle, taxID, tax_rate, config, ean, unit, pack_unit, articleDetailID)
...
INSERT INTO `s_order_shippingaddress` (id, userID, orderID, company, department, salutation, firstname, lastname, street, zipcode, city, countryID, stateID, additional_address_line1, additional_address_line2, title)
VALUES (1000, 1, 10000, 'shopware AG', '', 'mr', 'Max', 'Mustermann', 'Mustermannstraße 92', '48624', 'Schöppingen', 2, 3, '', '', NULL);

INSERT INTO `s_order_billingaddress` (id, userID, orderID, company, department, salutation, firstname, lastname, street, zipcode, city, phone, countryID, stateID)
